...
import lambda.geometry.Point2D
import lambda.geometry.visibility.VisibilityChecker
import lambda.geometry.visibility.VisibilityChecker.FailReason
import lambda.geometry.visibility.VisibilityChecker.FailReason.FailReason
...
object CheckVisibility {
  ...
  def renderReason(reason: Option[(Point2D, FailReason)]): String = reason match {
