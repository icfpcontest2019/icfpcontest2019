...
object ContestErrorMessages {
  ...
  val CALL_POINT_INSTALLED = "Cannot install something new in this cell."
  val TELEPORT_INSTALLED = "Cannot install something new in this cell."
  ...
  val CANNOT_CALL_FRIEND = "Cannot create new watchman in this location."
